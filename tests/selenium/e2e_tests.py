...
class SKFClickThrough(unittest.TestCase):
    ...
    def test_a_create_project(self):
        ...
        wait.until(EC.visibility_of_element_located((By.ID, "1"))).click()
        driver.find_element_by_id('add').click()
        inputName = driver.find_element_by_id("project_name")
        inputName.send_keys("test project")
        inputVersion = driver.find_element_by_id("project_version")
        inputVersion.send_keys("test v1.1")
        inputDesc = driver.find_element_by_id("project_descriptionription")
    ...
    def test_a_project_list(self):
        ...
        driver.find_element_by_id('add').click()
        inputName = driver.find_element_by_id("project_name")
        inputName.send_keys("test project 3")
        inputVersion = driver.find_element_by_id("project_version")
        inputVersion.send_keys("test v1.1")
        inputDesc = driver.find_element_by_id("project_descriptionription")
        inputDesc.send_keys("test description project")
    ...
    def test_a_project_and_sprint(self):
        ...
        driver.find_element_by_id("sprint").click()
        checklist = Select(driver.find_element_by_id("question"))
        checklist.select_by_index(2)
        driver.find_element_by_id("checklist").click()
        time.sleep(10)
        
        sprint_name.send_keys("test sprint")
        sprint_descriptionription = driver.find_element_by_id("sprint_descriptionription")
        sprint_descriptionription.send_keys("test sprint description")
        ...
        input.click()
        sprint_name = driver.find_element_by_id("sprint_name")
        sprint_name.send_keys("test sprint new")
        sprint_descriptionription = driver.find_element_by_id("sprint_descriptionription")
        sprint_descriptionription.send_keys("test sprint desc new")
    ...
    def test_h_create_new_checklist_item_flow(self):
        ...
        checklist_id = driver.find_element_by_name("checklist_id")
        checklist_id.send_keys("1.1")
