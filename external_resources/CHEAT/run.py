...
def get_cheat():
    ...
    shutil.move("CheatSheetSeries/cheatsheets", "../../Angular2/src/assets/training/secure_code/slides")
    shutil.move("CheatSheetSeries/assets", "../../Angular2/src/assets/training/secure_code/slides")
