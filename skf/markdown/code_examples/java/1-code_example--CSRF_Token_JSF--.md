...
when the page renders, the <cu:antiCSRF/> is created as a viewstate encoded html input tag which carries the antiCSRF token. While in process of rendering the page, a new token is generated
