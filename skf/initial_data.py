...
def load_initial_data():
    ...
    try:
        ...
        c = ChecklistKB('1.0', 'Architecture, Design and Threat Modeling Requirements', 1, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.1', 'Verify the use of a secure software development lifecycle that addresses security in all stages of development.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html', 2)
        c.question_id = 1
        c.kb_id = 272
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.2', 'Verify the use of threat modeling for every design change or sprint planning to identify threats, plan for countermeasures, facilitate appropriate risk responses, and guide security testing.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1053', 2)
        c.question_id = 1
        c.kb_id = 1053
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.3', 'Verify that all user stories and features contain functional security constraints, such as "As a user, I should be able to view and edit my profile. I should not be able to view or edit anyone else\s profile', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1110', 2)
        c.question_id = 1
        c.kb_id = 1110
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.4', 'Verify documentation and justification of all the application\s trust boundaries, components, and significant data flows.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1059',2)
        c.question_id = 1
        c.kb_id = 1059
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.5', 'Verify definition and security analysis of the application\s high-level architecture and all connected remote services. ', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1059', 2)
        c.question_id = 1
        c.kb_id = 1059
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.6', 'Verify implementation of centralized, simple (economy of design) vetted, secure, and reusable security controls to avoid duplicate, missing, ineffective, or insecure controls.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/637', 2)
        c.question_id = 1
        c.kb_id = 184
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.1.7', 'Verify availability of a secure coding checklist, security requirements, guideline, or policy to all developers and testers.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Attack_Surface_Analysis_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/637', 2)
        c.question_id = 1
        c.kb_id = 637
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.2.1', 'Verify the use of unique or special low-privilege operating system accounts for all application components, services, and servers.', 1, 'https://cwe.mitre.org/data/definitions/250', 2)
        c.question_id = 2
        c.kb_id = 250
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.2.2', 'Verify that communications between application components, including APIs, middleware and data layers, are authenticated. Components should have the least necessary privileges needed.', 1, 'https://cwe.mitre.org/data/definitions/306', 2)
        c.question_id = 2
        c.kb_id = 306
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.2.3', 'Verify that the application uses a single vetted authentication mechanism that is known to be secure, can be extended to include strong authentication, and has sufficient logging and monitoring to detect account abuse or breaches.', 1, 'https://cwe.mitre.org/data/definitions/306', 2)
        c.question_id = 2
        c.kb_id = 306
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.2.4', 'Verify that all authentication pathways and identity management APIs implement consistent authentication security control strength, such that there are no weaker alternatives per the risk of the application.', 1, 'https://cwe.mitre.org/data/definitions/306', 2)
        c.question_id = 2
        c.kb_id = 306
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.4.1', 'Verify that trusted enforcement points such as at access control gateways, servers, and serverless functions enforce access controls. Never enforce access controls on the client.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/602', 2)
        c.question_id = 3
        c.kb_id = 602
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.4.2', 'Verify that the chosen access control solution is flexible enough to meet the application\s needs.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/284', 2)
        c.question_id = 3
        c.kb_id = 284
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.4.3', 'Verify enforcement of the principle of least privilege in functions, data files, URLs, controllers, services, and other resources. This implies protection against spoofing and elevation of privilege.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/272', 2)
        c.question_id = 3
        c.kb_id = 272
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.4.4', 'Verify the application uses a single and well-vetted access control mechanism for accessing protected data and resources. All requests must pass through this single mechanism to avoid copy and paste or insecure alternative paths.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/284', 2)
        c.question_id = 3
        c.kb_id = 284
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.4.5', 'Verify that attribute or feature-based access control is used whereby the code checks the user\s authorization for a feature/data item rather than just their role.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/275', 2)
        c.question_id = 3
        c.kb_id = 274
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.5.1', 'Verify that input and output requirements clearly define how to handle and process data based on type, content, and applicable laws, regulations, and other policy compliance.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1029', 2)
        c.question_id = 4
        c.kb_id = 20
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.5.2', 'Verify that serialization is not used when communicating with untrusted clients. If this is not possible, ensure that adequate integrity controls (and possibly encryption if sensitive data is sent) are enforced to prevent deserialization attacks including object injection.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/502', 2)
        c.question_id = 4
        c.kb_id = 502
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.5.3', 'Verify that input validation is enforced on a trusted service layer.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/602', 2)
        c.question_id = 4
        c.kb_id = 602
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.5.4', 'Verify that output encoding occurs close to or by the interpreter for which it is intended.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 2)
        c.question_id = 4
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.6.1', 'Verify that there is an explicit policy for management of cryptographic keys and that a cryptographic key lifecycle follows a key management standard such as NIST SP 800-57.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 5
        c.kb_id = 320
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.6.2', 'Verify that consumers of cryptographic services protect key material and other secrets by using key vaults or API based alternatives.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 5
        c.kb_id = 320
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.6.3', 'Verify that all keys and passwords are replaceable and are part of a well-defined process to re-encrypt sensitive data.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 5
        c.kb_id = 204
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.6.4', 'Verify that symmetric keys, passwords, or API secrets generated by or shared with clients are used only in protecting low risk secrets, such as encrypting local storage, or temporary ephemeral uses such as parameter obfuscation. Sharing secrets with clients is clear-text equivalent and architecturally should be treated as such.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 5
        c.kb_id = 277
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.7.1', 'Verify that a common logging format and approach is used across the system.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1009', 2)
        c.question_id = 6
        c.kb_id = 1009
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.7.2', 'Verify that logs are securely transmitted to a preferably remote system for analysis, detection, alerting, and escalation.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html', 2)
        c.question_id = 6
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.8.1', 'Verify that all sensitive data is identified and classified into protection levels.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/User_Privacy_Protection_Cheat_Sheet.html', 2)
        c.question_id = 7
        c.kb_id = 278
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.8.2', 'Verify that all protection levels have an associated set of protection requirements, such as encryption requirements, integrity requirements, retention, privacy and other confidentiality requirements, and that these are applied in the architecture.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/User_Privacy_Protection_Cheat_Sheet.html', 2)
        c.question_id = 7
        c.kb_id = 278
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.9.1', 'Verify the application encrypts communications between components, particularly when these components are in different containers, systems, sites, or cloud providers.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/319', 2)
        c.question_id = 8
        c.kb_id = 319
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.9.2', 'Verify that application components verify the authenticity of each side in a communication link to prevent person-in-the-middle attacks. For example, application components should validate TLS certificates and chains.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/295', 2)
        c.question_id = 8
        c.kb_id = 295
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.10.1', 'Verify that a source code control system is in use, with procedures to ensure that check-ins are accompanied by issues or change tickets. The source code control system should have access control and identifiable users to allow traceability of any changes.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Third_Party_Javascript_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Virtual_Patching_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/284', 2)
        c.question_id = 9
        c.kb_id = 284
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.11.1', 'Verify the definition and documentation of all application components in terms of the business or security functions they provide.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1059', 2)
        c.question_id = 70
        c.kb_id = 1059
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.11.2', 'Verify that all high-value business logic flows, including authentication, session management and access control, do not share unsynchronized state.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/362', 2)
        c.question_id = 70
        c.kb_id = 362
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('1.11.3', 'Verify that all high-value business logic flows, including authentication, session management and access control are thread safe and resistant to time-of-check and time-of-use race conditions.', 1, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/362', 3)
        c.question_id = 70
        c.kb_id = 362
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.12.1', 'Verify that user-uploaded files are stored outside of the web root.', 1, 'https://cwe.mitre.org/data/definitions/552', 2)
        c.question_id = 71
        c.kb_id = 552
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.12.2', 'Verify that user-uploaded files - if required to be displayed or downloaded from the application - are served by either octet stream downloads, or from an unrelated domain, such as a cloud file storage bucket. Implement a suitable content security policy to reduce the risk from XSS vectors or other attacks from the uploaded file.', 1, 'https://cwe.mitre.org/data/definitions/646', 2)
        c.question_id = 71
        c.kb_id = 646
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.14.1', 'Verify the segregation of components of differing trust levels through well-defined security controls, firewall rules, API gateways, reverse proxies, cloud-based security groups, or similar mechanisms.', 1, 'https://cwe.mitre.org/data/definitions/923', 2)
        c.question_id = 72
        c.kb_id = 923
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.14.2', 'Verify that if deploying binaries to untrusted devices makes use of binary signatures, trusted connections, and verified endpoints.', 1, 'https://cwe.mitre.org/data/definitions/494', 2)
        c.question_id = 72
        c.kb_id = 494
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.14.3', 'Verify that the build pipeline warns of out-of-date or insecure components and takes appropriate actions.', 1, 'https://cwe.mitre.org/data/definitions/1104', 2)
        c.question_id = 72
        c.kb_id = 1104
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.14.4', 'Verify that the build pipeline contains a build step to automatically build and verify the secure deployment of the application, particularly if the application infrastructure is software defined, such as cloud environment build scripts.', 1, 'https://cwe.mitre.org/', 2)
        c.question_id = 72
        c.kb_id = 281
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.14.5', 'Verify that application deployments adequately sandbox, containerize and/or isolate at the network level to delay and deter attackers from attacking other applications, especially when they are performing sensitive or dangerous actions such as deserialization.', 1, 'https://cwe.mitre.org/data/definitions/265', 2)
        c.question_id = 72
        c.kb_id = 265
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('1.14.6', 'Verify the application does not use unsupported, insecure, or deprecated client-side technologies such as NSAPI plugins, Flash, Shockwave, ActiveX, Silverlight, NACL, or client-side Java applets.', 1, 'https://cwe.mitre.org/data/definitions/477', 2)
        c.question_id = 72
        c.kb_id = 477
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.0', 'Authentication Verification Requirements', 2, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.1.1', 'Verify that user set passwords are at least 12 characters in length. (C6)', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.2', 'Verify that passwords 64 characters or longer are permitted.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.3', 'Verify that passwords can contain spaces and truncation is not performed. Consecutive multiple spaces MAY optionally be coalesced.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.4', 'Verify that Unicode characters are permitted in passwords. A single Unicode code point is considered a character, so 12 emoji or 64 kanji characters should be valid and permitted.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.5', 'Verify users can change their password.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/620', 1)
        c.question_id = 10
        c.kb_id = 620
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.6', 'Verify that password change functionality requires the user\s current and new password.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/620', 1)
        c.question_id = 10
        c.kb_id = 620
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.7', 'Verify that passwords submitted during account registration, login, and password change are checked against a set of breached passwords either locally (such as the top 1,000 or 10,000 most common passwords which match the system\s password policy) or using an external API. If using an API a zero knowledge proof or other mechanism should be used to ensure that the plain text password is not sent or used in verifying the breach status of the password. If the password is breached, the application must require the user to set a new non-breached password.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.8', 'Verify that a password strength meter is provided to help users set a stronger password.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.9', 'Verify that there are no password composition rules limiting the type of characters permitted. There should be no requirement for upper or lower case or numbers or special characters.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('2.1.11', 'Verify that "paste" functionality, browser password helpers, and external password managers are permitted.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521',1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.1.12', 'Verify that the user can choose to either temporarily view the entire masked password, or temporarily view the last typed character of the password on platforms that do not have this as native functionality.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Credential_Stuffing_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/521', 1)
        c.question_id = 10
        c.kb_id = 521
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.2.1', 'Verify that anti-automation controls are effective at mitigating breached credential testing, brute force, and account lockout attacks. Such controls include blocking the most common breached passwords, soft lockouts, rate limiting, CAPTCHA, ever increasing delays between attempts, IP address restrictions, or risk-based restrictions such as location, first login on a device, recent attempts to unlock the account, or similar. Verify that no more than 100 failed attempts per hour is possible on a single account.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/307', 1)
        c.question_id = 11
        c.kb_id = 307
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.2.2', 'Verify that the use of weak authenticators (such as SMS and email) is limited to secondary verification and transaction approval and not as a replacement for more secure authentication methods. Verify that stronger methods are offered before weak methods, users are aware of the risks, or that proper measures are in place to limit the risks of account compromise.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/304', 1)
        c.question_id = 11
        c.kb_id = 304
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.2.3', 'Verify that secure notifications are sent to users after updates to authentication details, such as credential resets, email or address changes, logging in from unknown or risky locations. The use of push notifications - rather than SMS or email - is preferred, but in the absence of push notifications, SMS or email is acceptable as long as no sensitive information is disclosed in the notification.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/620', 1)
        c.question_id = 11
        c.kb_id = 620
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.2.4', 'Verify impersonation resistance against phishing, such as the use of multi-factor authentication, cryptographic devices with intent (such as connected keys with a push to authenticate), or at higher AAL levels, client-side certificates.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/308', 3)
        c.question_id = 11
        c.kb_id = 308
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.2.5', 'Verify that where a credential service provider (CSP) and the application verifying authentication are separated, mutually authenticated TLS is in place between the two endpoints.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/319', 3)
        c.question_id = 11
        c.kb_id = 319
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.2.6', 'Verify replay resistance through the mandated use of OTP devices, cryptographic authenticators, or lookup codes.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/308', 3)
        c.question_id = 11
        c.kb_id = 308
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.2.7', 'Verify intent to authenticate by requiring the entry of an OTP token or user-initiated action such as a button press on a FIDO hardware key.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/308', 3)
        c.question_id = 11
        c.kb_id = 308
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.3.1', 'Verify system generated initial passwords or activation codes SHOULD be securely randomly generated, SHOULD be at least 6 characters long, and MAY contain letters and numbers, and expire after a short period of time. These initial secrets must not be permitted to become the long term password.', 2, 'https://cwe.mitre.org/data/definitions/330', 1)
        c.question_id = 12
        c.kb_id = 330
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.3.2', 'Verify that enrollment and use of subscriber-provided authentication devices are supported, such as a U2F or FIDO tokens.', 2, 'https://cwe.mitre.org/data/definitions/308', 2)
        c.question_id = 12
        c.kb_id = 308
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.3.3', 'Verify that renewal instructions are sent with sufficient time to renew time bound authenticators.', 2, 'https://cwe.mitre.org/data/definitions/287', 2)
        c.question_id = 12
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.4.1', 'Verify that passwords are stored in a form that is resistant to offline attacks. Passwords SHALL be salted and hashed using an approved one- way key derivation or password hashing function. Key derivation and password hashing functions take a password, a salt, and a cost factor as inputs when generating a password hash.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Password_Storage_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/916', 2)
        c.question_id = 13
        c.kb_id = 916
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.4.2', 'Verify that the salt is at least 32 bits in length and be chosen arbitrarily to minimize salt value collisions among stored hashes. For each credential, a unique salt value and the resulting hash SHALL be stored.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Password_Storage_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/916', 2)
        c.question_id = 13
        c.kb_id = 916
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.4.3', 'Verify that if PBKDF2 is used, the iteration count SHOULD be as large as verification server performance will allow, typically at least 100,000 iterations.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Password_Storage_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/916', 2)
        c.question_id = 13
        c.kb_id = 916
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.4.4', 'Verify that if bcrypt is used, the work factor SHOULD be as large as verification server performance will allow, typically at least 13', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Password_Storage_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/916', 2)
        c.question_id = 13
        c.kb_id = 916
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.4.5', 'Verify that an additional iteration of a key derivation function is performed, using a salt value that is secret and known only to the verifier. Generate the salt value using an approved random bit generator [SP 800-90Ar1] and provide at least the minimum security strength specified in the latest revision of SP 800-131A. The secret salt value SHALL be stored separately from the hashed passwords (e.g., in a specialized device like a hardware security module).', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Password_Storage_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/916', 2)
        c.question_id = 13
        c.kb_id = 916
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.5.1', 'Verify that a system generated initial activation or recovery secret is not sent in clear text to the user.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/640', 1)
        c.question_id = 14
        c.kb_id = 640
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.5.2', 'Verify password hints or knowledge-based authentication (so-called "secret questions") are not present.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/640', 1)
        c.question_id = 14
        c.kb_id = 640
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.5.3', 'Verify password credential recovery does not reveal the current password in any way.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/640', 1)
        c.question_id = 14
        c.kb_id = 640
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.5.4', 'Verify shared or default accounts are not present (e.g. "root", "admin", or "sa").', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/16', 1)
        c.question_id = 14
        c.kb_id = 276
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.5.5', 'Verify that if an authentication factor is changed or replaced, that the user is notified of this event.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/304', 1)
        c.question_id = 14
        c.kb_id = 304
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.5.6', 'Verify forgotten password, and other recovery paths use a secure recovery mechanism, such as TOTP or other soft token, mobile push, or another offline recovery mechanism. ', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/640', 1)
        c.question_id = 14
        c.kb_id = 640
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.5.7', 'Verify that if OTP or multi-factor authentication factors are lost, that evidence of identity proofing is performed at the same level as during enrollment.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Choosing_and_Using_Security_Questions_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/308', 2)
        c.question_id = 14
        c.kb_id = 308
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.6.1', 'Verify that lookup secrets can be used only once.', 2, 'https://cwe.mitre.org/data/definitions/308', 2)
        c.question_id = 15
        c.kb_id = 290
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.6.2', 'Verify that lookup secrets have sufficient randomness (112 bits of entropy), or if less than 112 bits of entropy, salted with a unique and random 32-bit salt and hashed with an approved one-way hash', 2, 'https://cwe.mitre.org/data/definitions/330', 2)
        c.question_id = 15
        c.kb_id = 330
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.6.3', 'Verify that lookup secrets are resistant to offline attacks, such as predictable values.', 2, 'https://cwe.mitre.org/data/definitions/310', 2)
        c.question_id = 15
        c.kb_id = 310
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.7.1', 'Verify that clear text out of band (NIST "restricted") authenticators, such as SMS or PSTN, are not offered by default, and stronger alternatives such as push notifications are offered first.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/287', 1)
        c.question_id = 16
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.7.2', 'Verify that the out of band verifier expires out of band authentication requests, codes, or tokens after 10 minutes.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/287', 1)
        c.question_id = 16
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.7.3', 'Verify that the out of band verifier authentication requests, codes, or tokens are only usable once, and only for the original authentication request.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/287', 1)
        c.question_id = 16
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.7.4', 'Verify that the out of band authenticator and verifier communicates over a secure independent channel.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/523', 1)
        c.question_id = 16
        c.kb_id = 523
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.7.5', 'Verify that the out of band verifier retains only a hashed version of the authentication code.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/256', 2)
        c.question_id = 16
        c.kb_id = 256
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.7.6', 'Verify that the initial authentication code is generated by a secure random number generator, containing at least 20 bits of entropy (typically a six digital random number is sufficient).', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Forgot_Password_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/310', 2)
        c.question_id = 16
        c.kb_id = 310
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.8.1', 'Verify that time-based OTPs have a defined lifetime before expiring.', 2, 'https://cwe.mitre.org/data/definitions/613', 1)
        c.question_id = 17
        c.kb_id = 613
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('2.8.2', 'Verify that symmetric keys used to verify submitted OTPs are highly protected, such as by using a hardware security module or secure operating system based key storage.', 2, 'https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 17
        c.kb_id = 320
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.8.3', 'Verify that approved cryptographic algorithms are used in the generation, seeding, and verification.', 2, 'https://cwe.mitre.org/data/definitions/326', 2)
        c.question_id = 17
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.8.4', 'Verify that time-based OTP can be used only once within the validity period.', 2, 'https://cwe.mitre.org/data/definitions/287', 2)
        c.question_id = 17
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.8.5', 'Verify that if a time-based multi factor OTP token is re-used during the validity period, it is logged and rejected with secure notifications being sent to the holder of the device.', 2, 'https://cwe.mitre.org/data/definitions/287', 2)
        c.question_id = 17
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.8.6', 'Verify physical single factor OTP generator can be revoked in case of theft or other loss. Ensure that revocation is immediately effective across logged in sessions, regardless of location.', 2, 'https://cwe.mitre.org/data/definitions/613', 2)
        c.question_id = 17 
        c.kb_id = 613
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.8.7', 'Verify that biometric authenticators are limited to use only as 308 5.2.3 secondary factors in conjunction with either something you have and something you know.', 2, 'https://cwe.mitre.org/data/definitions/308', 3)
        c.question_id = 17 
        c.kb_id = 308
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.9.1', 'Verify that cryptographic keys used in verification are stored securely and protected against disclosure, such as using a TPM or HSM, or an OS service that can use this secure storage.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 18
        c.kb_id = 320
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.9.2', 'Verify that the challenge nonce is at least 64 bits in length, and statistically unique or unique over the lifetime of the cryptographic device.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/330', 2)
        c.question_id = 18
        c.kb_id = 330
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.9.3', 'Verify that approved cryptographic algorithms are used in the generation, seeding, and verification.', 2, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/327', 2)
        c.question_id = 18
        c.kb_id = 327
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.10.1', 'Verify that integration secrets do not rely on unchanging passwords, such as API keys or shared privileged accounts.', 2, "https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/287", 2)
        c.question_id = 19
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.10.2', 'Verify that if passwords are required, the credentials are not a default account', 2, 'https://cwe.mitre.org/data/definitions/255', 2)
        c.question_id = 19
        c.kb_id = 287
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.10.3', 'Verify that passwords are stored with sufficient protection to prevent offline recovery attacks, including local system access.', 2, 'https://cwe.mitre.org/data/definitions/522', 2)
        c.question_id = 19
        c.kb_id = 522
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('2.10.4', 'Verify passwords, integrations with databases and third-party systems, seeds and internal secrets, and API keys are managed securely and not included in the source code or stored within source code repositories. Such storage SHOULD resist offline attacks. The use of a secure software key store (L1), hardware trusted platform module (TPM), or a hardware security module (L3) is recommended for password storage.', 2, 'https://cwe.mitre.org/data/definitions/798', 2)
        c.question_id = 19
        c.kb_id = 798
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('3.0', 'Session Management Verification Requirements', 3, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.1.1', 'Verify the application never reveals session tokens in URL parameters or error messages.', 3, 'https://cwe.mitre.org/data/definitions/598', 1)
        c.question_id = 20
        c.kb_id = 598
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.2.1', 'Verify the application generates a new session token on user authentication.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/384', 1)
        c.question_id = 21
        c.kb_id = 384
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.2.2', 'Verify that session tokens possess at least 64 bits of entropy.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/311', 1)
        c.question_id = 21
        c.kb_id = 311
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.2.3', 'Verify the application only stores session tokens in the browser using secure methods such as appropriately secured cookies (see section 3.4) or HTML 5 session storage.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/539', 1)
        c.question_id = 21
        c.kb_id = 539
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('3.2.4', 'Verify that session token are generated using approved cryptographic algorithms', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/331', 2)
        c.question_id = 21
        c.kb_id = 331
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.3.1', 'Verify that logout and expiration invalidate the session token, such that the back button or a downstream relying party does not resume an authenticated session, including across relying parties.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/613', 1)
        c.question_id = 22
        c.kb_id = 613
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.3.2', 'If authenticators permit users to remain logged in, verify that re-authentication occurs periodically both when actively used or after an idle period.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/613', 1)
        c.question_id = 22
        c.kb_id = 613
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.3.3', 'Verify that the application terminates all other active sessions after a successful password change, and that this is effective across the application, federated login (if present) and any relying parties.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/613', 2)
        c.question_id = 22
        c.kb_id = 613
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.3.4', 'Verify that users are able to view and log out of any or all currently active sessions and devices.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/613', 2)
        c.question_id = 22
        c.kb_id = 613
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.4.1', 'Verify that cookie-based session tokens have the \Secure\ attribute set.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/614', 1)
        c.question_id = 23
        c.kb_id = 614
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.4.2', 'Verify that cookie-based session tokens have the \HttpOnly\ attribute set.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1004', 1)
        c.question_id = 23
        c.kb_id = 1004
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.4.3', 'Verify that cookie-based session tokens utilize the \SameSite\ attribute to limit exposure to cross-site request forgery attacks.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/16', 1)
        c.question_id = 23
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.4.4', 'Verify that cookie-based session tokens use "__Host-" prefix (see references) to provide session cookie confidentiality.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/16', 1)
        c.question_id = 23
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('3.4.5', 'Verify that if the application is published under a domain name with other applications that set or use session cookies that might override or disclose the session cookies, set the path attribute in cookie-based session tokens using the most precise path possible.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/16', 1)
        c.question_id = 23
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('3.5.1', 'Verify the application does not treat OAuth and refresh tokens — on their own — as the presence of the subscriber and allows users to terminate trust relationships with linked applications.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/JSON_Web_Token_for_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/290', 2)
        c.question_id = 24
        c.kb_id = 290
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('3.5.2', 'Verify the application uses session tokens rather than static API secrets and keys, except with legacy implementations.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/JSON_Web_Token_for_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/798', 2)
        c.question_id = 24
        c.kb_id = 798
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('3.5.3', 'Verify that stateless session tokens use digital signatures, encryption, and other countermeasures to protect against tampering, enveloping, replay, null cipher, and key substitution attacks.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/JSON_Web_Token_for_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/345', 2)
        c.question_id = 24
        c.kb_id = 345
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('3.7.1', 'Verify the application ensures a valid login session or requires re-authentication or secondary verification before allowing any sensitive transactions or account modifications.', 3, 'https://cheatsheetseries.owasp.org/cheatsheets/Session_Management_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transaction_Authorization_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/778', 1)
        c.question_id = 25
        c.kb_id = 778
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.0', 'Access Control Verification Requirements', 4, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.1.1', 'Verify that the application enforces access control rules on a trusted service layer, especially if client-side access control is present and could be bypassed.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Access_Control_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/602', 1)
        c.question_id = 26
        c.kb_id = 602
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.1.2', 'Verify that all user and data attributes and policy information used by access controls cannot be manipulated by end users unless specifically authorized.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Access_Control_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/639', 1)
        c.question_id = 26
        c.kb_id = 639
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.1.3', 'Verify that the principle of least privilege exists - users should only be able to access functions, data files, URLs, controllers, services, and other resources, for which they possess specific authorization. This implies protection against spoofing and elevation of privilege.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Access_Control_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/285', 1)
        c.question_id = 26
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.1.4', 'Verify that the principle of deny by default exists whereby new users/roles start with minimal or no permissions and users/roles do not receive access to new features until access is explicitly assigned. ', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Access_Control_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/276', 1)
        c.question_id = 26
        c.kb_id = 276
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.1.5', 'Verify that access controls fail securely including when an exception occurs.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Access_Control_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/285', 1)
        c.question_id = 26
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.2.1', 'Verify that sensitive data and APIs are protected against direct object attacks targeting creation, reading, updating and deletion of records, such as creating or updating someone else\s record, viewing everyone\s records, or deleting all records.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Insecure_Direct_Object_Reference_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/639',1 )
        c.question_id = 27
        c.kb_id = 639
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.2.2', 'Verify that the application or framework enforces a strong anti-CSRF mechanism to protect authenticated functionality, and effective anti-automation or anti-CSRF protects unauthenticated functionality.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/Insecure_Direct_Object_Reference_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Testing_Automation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/352', 1)
        c.question_id = 27
        c.kb_id = 352
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.3.1', 'Verify administrative interfaces use appropriate multi-factor authentication to prevent unauthorized use.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/419', 1)
        c.question_id = 28
        c.kb_id = 419
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.3.2', 'Verify that directory browsing is disabled unless deliberately desired. Additionally, applications should not allow discovery or disclosure of file or directory metadata, such as Thumbs.db, .DS_Store, .git or .svn folders.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/548', 1)
        c.question_id = 28
        c.kb_id = 548
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('4.3.3', 'Verify the application has additional authorization (such as step up or adaptive authentication) for lower value systems, and / or segregation of duties for high value applications to enforce anti-fraud controls as per the risk of application and past fraud.', 4, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/732', 1)
        c.question_id = 28
        c.kb_id = 732
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.0', 'Validation, Sanitization and Encoding Verification Requirements', 5, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.1.1', 'Verify that the application has defenses against HTTP parameter pollution attacks, particularly if the application framework makes no distinction about the source of request parameters (GET, POST, cookies, headers, or environment variables).', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Mass_Assignment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/235', 1)
        c.question_id = 29
        c.kb_id = 235
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.1.2', 'Verify that frameworks protect against mass parameter assignment attacks, or that the application has countermeasures to protect against unsafe parameter assignment, such as marking fields private or similar.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Mass_Assignment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/915', 1)
        c.question_id = 29
        c.kb_id = 915
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.1.3', 'Verify that all input (HTML form fields, REST requests, URL parameters, HTTP headers, cookies, batch files, RSS feeds, etc) is validated using positive validation (whitelisting)', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Mass_Assignment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/20', 1)
        c.question_id = 29
        c.kb_id = 20
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.1.4', 'Verify that structured data is strongly typed and validated against a defined schema including allowed characters, length and pattern (e.g. credit card numbers or telephone, or validating that two related fields are reasonable, such as checking that suburb and zip/postcode match).', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Mass_Assignment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/20', 1)
        c.question_id = 29
        c.kb_id = 20
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.1.5', 'Verify that URL redirects and forwards only allow whitelisted destinations, or show a warning when redirecting to potentially untrusted content.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Mass_Assignment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/601', 1)
        c.question_id = 29
        c.kb_id = 601
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.1', 'Verify that all untrusted HTML input from WYSIWYG editors or similar is properly sanitized with an HTML sanitizer library or framework feature.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 1)
        c.question_id = 30
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.2', 'Verify that unstructured data is sanitized to enforce safety measures such as allowed characters and length.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/138', 1)
        c.question_id = 30
        c.kb_id = 138
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.3', 'Verify that the application sanitizes user input before passing to mail systems to protect against SMTP or IMAP injection.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/147', 1)
        c.question_id = 30
        c.kb_id = 147
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.4', 'Verify that the application avoids the use of eval() or other dynamic code execution features. Where there is no alternative, any user input being included must be sanitized or sandboxed before being executed.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/95', 1)
        c.question_id = 30
        c.kb_id = 95
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.5', 'Verify that the application protects against template injection attacks by ensuring that any user input being included is sanitized or sandboxed.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/94', 1)
        c.question_id = 30
        c.kb_id = 94
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.6', 'Verify that the application protects against SSRF attacks, by validating or sanitizing untrusted data or HTTP file metadata, such as filenames and URL input fields, use whitelisting of protocols, domains, paths and ports.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/918', 1)
        c.question_id = 30
        c.kb_id = 918
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.7', 'Verify that the application sanitizes, disables, or sandboxes user-supplied SVG scriptable content, especially as they relate to XSS resulting from inline scripts, and foreignObject.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/159', 1)
        c.question_id = 30
        c.kb_id = 159
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.2.8', 'Verify that the application sanitizes, disables, or sandboxes user-supplied scriptable or expression template language content, such as Markdown, CSS or XSL stylesheets, BBCode, or similar.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/94', 1)
        c.question_id = 30
        c.kb_id = 94
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.1', 'Verify that output encoding is relevant for the interpreter and context required. For example, use encoders specifically for HTML values, HTML attributes, JavaScript, URL Parameters, HTTP headers, SMTP, and others as the context requires, especially from untrusted inputs (e.g. names with Unicode or apostrophes, such as bla or OHara).', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 1)
        c.question_id = 31
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.2', 'Verify that output encoding preserves the user\s chosen character set and locale, such that any Unicode character point is valid and safely handled.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/176', 1)
        c.question_id = 31
        c.kb_id = 176
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.3', 'Verify that context-aware, preferably automated - or at worst, manual - output escaping protects against reflected, stored, and DOM based XSS.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/79', 1)
        c.question_id = 31
        c.kb_id = 79
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.4', 'Verify that data selection or database queries (e.g. SQL, HQL, ORM, NoSQL) use parameterized queries, ORMs, entity frameworks, or are otherwise protected from database injection attacks.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/89', 1)
        c.question_id = 33
        c.kb_id = 89
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.5', 'Verify that where parameterized or safer mechanisms are not present, context-specific output encoding is used to protect against injection attacks, such as the use of SQL escaping to protect against SQL injection.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/89', 1)
        c.question_id = 33
        c.kb_id = 89
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.6', 'Verify that the application projects against JavaScript or JSON injection attacks, including for eval attacks, remote JavaScript includes, CSP bypasses, DOM XSS, and JavaScript expression evaluation.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/830', 1)
        c.question_id = 31
        c.kb_id = 830
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.7', 'Verify that the application protects against LDAP Injection vulnerabilities, or that specific security controls to prevent LDAP Injection have been implemented.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/943', 1)
        c.question_id = 34
        c.kb_id = 943
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.8', 'Verify that the application protects against OS command injection and that operating system calls use parameterized OS queries or use contextual command line output encoding.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/78', 1)
        c.question_id = 35
        c.kb_id = 78
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.9', 'Verify that the application protects against Local File Inclusion (LFI) or Remote File Inclusion (RFI) attacks.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/829', 1)
        c.question_id = 32
        c.kb_id = 829
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.3.10', 'Verify that the application protects against XPath injection or XML injection attacks.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/DOM_based_XSS_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/HTML5_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Injection_Prevention_in_Java_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/LDAP_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/OS_Command_Injection_Defense_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Bean_Validation_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/643', 1)
        c.question_id = 36
        c.kb_id = 643
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('5.5.1', 'Verify that serialized objects use integrity checks or are encrypted to prevent hostile object creation or data tampering.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/502', 1)
        c.question_id = 37
        c.kb_id = 502
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.5.2', 'Verify that the application correctly restricts XML parsers to only use the most restrictive configuration possible and to ensure that unsafe features such as resolving external entities are disabled to prevent XXE.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/611',1 )
        c.question_id = 37
        c.kb_id = 611
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.5.3', 'Verify that deserialization of untrusted data is avoided or is protected in both custom code and third-party libraries (such as JSON, XML and YAML parsers).', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/502', 1)
        c.question_id = 37
        c.kb_id = 502
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('5.5.4', 'Verify that when parsing JSON in browsers or JavaScript-based backends, JSON.parse is used to parse the JSON document. Do not use eval() to parse JSON.', 5, 'https://cheatsheetseries.owasp.org/cheatsheets/Deserialization_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/95', 1)
        c.question_id = 37
        c.kb_id = 95
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('6.0', 'Stored Cryptography Verification Requirements', 6, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('6.1.1', 'Verify that regulated private data is stored encrypted while at rest, such as personally identifiable information (PII), sensitive personal information, or data assessed likely to be subject to EUs GDPR.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/User_Privacy_Protection_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/311', 2)
        c.question_id = 38
        c.kb_id = 311
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('6.1.2', 'Verify that regulated health data is stored encrypted while at rest, such as medical records, medical device details, or de-anonymized research records.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/User_Privacy_Protection_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/311', 2)
        c.question_id = 38
        c.kb_id = 311
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.1.3', 'Verify that regulated financial data is stored encrypted while at rest, such as financial accounts, defaults or credit history, tax records, pay history, beneficiaries, or de-anonymized market or research records.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/User_Privacy_Protection_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/311', 2)
        c.question_id = 38
        c.kb_id = 311
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.1', 'Verify that all cryptographic modules fail securely, and errors are handled in a way that does not enable Padding Oracle attacks.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/310', 1)
        c.question_id = 39
        c.kb_id = 310
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.2', 'Verify that industry proven or government approved cryptographic algorithms, modes, and libraries are used, instead of custom coded cryptography.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/327', 2)
        c.question_id = 39
        c.kb_id = 327
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('6.2.3', 'Verify that encryption initialization vector, cipher configuration, and block modes are configured securely using the latest advice.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 2)
        c.question_id = 39
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.4', 'Verify that random number, encryption or hashing algorithms, key lengths, rounds, ciphers or modes, can be reconfigured, upgraded, or swapped at any time, to protect against cryptographic breaks.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 2)
        c.question_id = 39
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.5', 'Verify that known insecure block modes (i.e. ECB, etc.), padding modes (i.e. PKCS#1 v1.5, etc.), ciphers with small block sizes (i.e. Triple-DES, Blowfish, etc.), and weak hashing algorithms (i.e. MD5, SHA1, etc.) are not used unless required for backwards compatibility.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 2)
        c.question_id = 39
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.6', 'Verify that nonces, initialization vectors, and other single use numbers must not be used more than once with a given encryption key. The method of generation must be appropriate for the algorithm being used.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 2)
        c.question_id = 39
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.7', 'Verify that encrypted data is authenticated via signatures, authenticated cipher modes, or HMAC to ensure that ciphertext is not altered by an unauthorized party.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 3)
        c.question_id = 39
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.2.8', 'Verify that all cryptographic operations are constant-time, with no short-circuit operations in comparisons, calculations, or returns, to avoid leaking information', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 3)
        c.question_id = 39
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.3.1', 'Verify that all random numbers, random file names, random GUIDs, and random strings are generated using the cryptographic modules approved cryptographically secure random number generator when these random values are intended to be not guessable by an attacker.', 6, 'https://cwe.mitre.org/data/definitions/338', 2)
        c.question_id = 40
        c.kb_id = 338
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.3.2', 'Verify that random GUIDs are created using the GUID v4 algorithm, and a cryptographically-secure pseudo-random number generator (CSPRNG). GUIDs created using other pseudo-random number generators may be predictable.', 6, 'https://cwe.mitre.org/data/definitions/338', 2)
        c.question_id = 40
        c.kb_id = 338
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.3.3', 'Verify that random numbers are created with proper entropy even when the application is under heavy load, or that the application degrades gracefully in such circumstances.', 6, 'https://cwe.mitre.org/data/definitions/338', 3)
        c.question_id = 40
        c.kb_id = 338
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.4.1', 'Verify that a secrets management solution such as a key vault is used to securely create, store, control access to and destroy secrets.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/798', 2)
        c.question_id = 41
        c.kb_id = 798
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('6.4.2', 'Verify that key material is not exposed to the application but instead uses an isolated security module like a vault for cryptographic operations.', 6, 'https://cheatsheetseries.owasp.org/cheatsheets/Key_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/320', 2)
        c.question_id = 41
        c.kb_id = 320
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.0', 'Error Handling and Logging Verification Requirements', 7, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('7.1.1', 'Verify that the application does not log credentials or payment details. Session tokens should only be stored in logs in an irreversible, hashed form.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/532', 1)
        c.question_id = 42
        c.kb_id = 532
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.1.2', 'Verify that the application does not log other sensitive data as defined under local privacy laws or relevant security policy.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/532', 1)
        c.question_id = 42
        c.kb_id = 532
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.1.3', 'Verify that the application logs security relevant events including successful and failed authentication events, access control failures, deserialization failures and input validation failures.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/778', 2)
        c.question_id = 42
        c.kb_id = 778
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.1.4', 'Verify that each log event includes necessary information that would allow for a detailed investigation of the timeline when an event happens', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/778', 2)
        c.question_id = 42
        c.kb_id = 778
        db.session.add(c)
        db.session.commit()     

        c = ChecklistKB('7.2.1', 'Verify that all authentication decisions are logged, without storing sensitive session identifiers or passwords. This should include requests with relevant metadata needed for security investigations.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/778', 2)
        c.question_id = 43
        c.kb_id = 778
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.2.2', 'Verify that all access control decisions can be logged and all failed decisions are logged. This should include requests with relevant metadata needed for security investigations.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/285', 2)
        c.question_id = 43
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.3.1', 'Verify that the application appropriately encodes user-supplied data to prevent log injection', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/117', 2)
        c.question_id = 44
        c.kb_id = 117
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.3.2', 'Verify that all events are protected from injection when viewed in log viewing software', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/117', 2)
        c.question_id = 44
        c.kb_id = 117
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.3.3', 'Verify that security logs are protected from unauthorized access and modification.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/200', 2)
        c.question_id = 44
        c.kb_id = 200
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.3.4', 'Verify that time sources are synchronized to the correct time and time zone. Strongly consider logging only in UTC if systems are global to assist with post- incident forensic analysis.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Logging_Cheat_Sheet.html', 2)
        c.question_id = 44
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.4.1', 'Verify that a generic message is shown when an unexpected or security sensitive error occurs, potentially with a unique ID which support personnel can use to investigate.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Error_Handling_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/210', 1)
        c.question_id = 45
        c.kb_id = 210
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.4.2', 'Verify that exception handling (or a functional equivalent) is used across the codebase to account for expected and unexpected error conditions.', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Error_Handling_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/544', 2)
        c.question_id = 45
        c.kb_id = 544
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.4.3', 'Verify that a last resort error handler is defined which will catch all unhandled exceptions', 7, 'https://cheatsheetseries.owasp.org/cheatsheets/Error_Handling_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/460', 2)
        c.question_id = 45
        c.kb_id = 460
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.0', 'Error Handling and Logging Verification Requirements', 8, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.1.1', 'Verify the application protects sensitive data from being cached in server components such as load balancers and application caches.', 8, 'https://cwe.mitre.org/data/definitions/532', 2)
        c.question_id = 46
        c.kb_id = 532
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.1.2', 'Verify that all cached or temporary copies of sensitive data stored on the server are protected from unauthorized access or purged/invalidated after the authorized user accesses the sensitive data.', 8, 'https://cwe.mitre.org/data/definitions/524', 2)
        c.question_id = 19
        c.kb_id = 524
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.1.3', 'Verify the application minimizes the number of parameters in a request, such as hidden fields, Ajax variables, cookies and header values.', 8, 'https://cwe.mitre.org/data/definitions/233', 2)
        c.question_id = 46
        c.kb_id = 233
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.1.4', 'Verify the application can detect and alert on abnormal numbers of requests, such as by IP, user, total per hour or day, or whatever makes sense for the application.', 8, 'https://cwe.mitre.org/data/definitions/525', 2)
        c.question_id = 46
        c.kb_id = 525
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.1.5', 'Verify that regular backups of important data are performed and that test restoration of data is performed.', 8, 'https://cwe.mitre.org/data/definitions/770', 3)
        c.question_id = 46
        c.kb_id = 770
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.1.6', 'Verify that backups are stored securely to prevent data from being stolen or corrupted.', 8, 'https://cwe.mitre.org/data/definitions/19', 3)
        c.question_id = 46
        c.kb_id = 300
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.2.1', 'Verify the application sets sufficient anti-caching headers so that sensitive data is not cached in modern browsers.', 8, 'https://cwe.mitre.org/data/definitions/525', 1)
        c.question_id = 25
        c.kb_id = 525
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.2.2', 'Verify that data stored in client side storage (such as HTML5 local storage, session storage, IndexedDB, regular cookies or Flash cookies) does not contain sensitive data or PII.', 8, 'https://cwe.mitre.org/data/definitions/922', 1)
        c.question_id = 47
        c.kb_id = 922
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.2.3', 'Verify that authenticated data is cleared from client storage, such as the browser DOM, after the client or session is terminated.', 8, 'https://cwe.mitre.org/data/definitions/922', 1)
        c.question_id = 47
        c.kb_id = 922
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.3.1', 'Verify that sensitive data is sent to the server in the HTTP message body or headers, and that query string parameters from any HTTP verb do not contain sensitive data.', 8, 'https://cwe.mitre.org/data/definitions/319', 1)
        c.question_id = 48
        c.kb_id = 319
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.3.2', 'Verify that users have a method to remove or export their data on demand.', 8, 'https://cwe.mitre.org/data/definitions/212', 1)
        c.question_id = 48
        c.kb_id = 212
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.3.3', 'Verify that users are provided clear language regarding collection and use of supplied personal information and that users have provided opt-in consent for the use of that data before it is used in any way.', 8, 'https://cwe.mitre.org/data/definitions/285', 1)
        c.question_id = 48
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('8.3.4', 'Verify that all sensitive data created and processed by the application has been identified, and ensure that a policy is in place on how to deal with sensitive data.', 8, 'https://cwe.mitre.org/data/definitions/200', 1)
        c.question_id = 48
        c.kb_id = 200
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.3.5', 'Verify accessing sensitive data is audited (without logging the sensitive data itself), if the data is collected under relevant data protection directives or where logging of access is required.', 8, 'https://cwe.mitre.org/data/definitions/532', 2)
        c.question_id = 48
        c.kb_id = 532
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.3.6', 'Verify that sensitive information contained in memory is overwritten as soon as it is no longer required to mitigate memory dumping attacks, using zeroes or random data.', 8, 'https://cwe.mitre.org/data/definitions/226', 2)
        c.question_id = 48
        c.kb_id = 226
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.3.7', 'Verify that sensitive or private information that is required to be encrypted, is encrypted using approved algorithms that provide both confidentiality and integrity', 8, 'https://cwe.mitre.org/data/definitions/525', 2)
        c.question_id = 48
        c.kb_id = 525
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('8.3.8', 'Verify that sensitive personal information is subject to data retention classification, such that old or out of date data is deleted automatically, on a schedule, or as the situation requires.', 8, 'https://cwe.mitre.org/data/definitions/285', 2)
        c.question_id = 48
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('9.0', 'Communications Verification Requirements', 9, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('9.1.1', 'Verify that secured TLS is used for all client connectivity, and does not fall back to insecure or unencrypted protocols.', 9, 'https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Strict_Transport_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/319',1 )
        c.question_id = 49
        c.kb_id = 319
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('9.1.2', 'Verify using online or up to date TLS testing tools that only strong algorithms, ciphers, and protocols are enabled, with the strongest algorithms and ciphers set as preferred.', 9, 'https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Strict_Transport_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 1)
        c.question_id = 49
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('9.1.3', 'Verify that old versions of SSL and TLS protocols, algorithms, ciphers, and configuration are disabled, such as SSLv2, SSLv3, or TLS 1.0 and TLS 1.1. The latest version of TLS should be the preferred cipher suite.', 9, 'https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Strict_Transport_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Transport_Layer_Protection_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/TLS_Cipher_String_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/326', 1)
        c.question_id = 49
        c.kb_id = 326
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('9.2.1', 'Verify that connections to and from the server use trusted TLS certificates. Where internally generated or self-signed certificates are used, the server must be configured to only trust specific internal CAs and specific self-signed certificates. All others should be rejected.', 9, 'https://cwe.mitre.org/data/definitions/295', 2)
        c.question_id = 50
        c.kb_id = 295
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('9.2.2', 'Verify that encrypted communications such as TLS is used for all inbound and outbound connections, including for management ports, monitoring, authentication, API, or web service calls, database, cloud, serverless, mainframe, external, and partner connections. The server must not fall back to insecure or unencrypted protocols.', 9, 'https://cwe.mitre.org/data/definitions/319', 2)
        c.question_id = 50
        c.kb_id = 319
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('9.2.3', 'Verify that all encrypted connections to external systems that involve sensitive information or functions are authenticated.', 9, 'https://cwe.mitre.org/data/definitions/297', 2)
        c.question_id = 50
        c.kb_id = 297
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('9.2.4', 'Verify that proper certification revocation, such as Online Certificate Status Protocol (OCSP) Stapling, is enabled and configured.', 9, 'https://cwe.mitre.org/data/definitions/299', 2)
        c.question_id = 50
        c.kb_id = 299
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('9.2.5', 'Verify that backend TLS connection failures are logged', 9, 'https://cwe.mitre.org/data/definitions/544', 3)
        c.question_id = 50
        c.kb_id = 544
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.0', 'Malicious Code Verification Requirements', 10, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.1.1', 'Verify that a code analysis tool is in use that can detect potentially malicious code, such as time functions, unsafe file operations and network connections.', 10, 'https://cheatsheetseries.owasp.org/cheatsheets/Third_Party_Javascript_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/749', 3)
        c.question_id = 51
        c.kb_id = 749
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('10.2.1', 'Verify that the application source code and third party libraries do not contain unauthorized phone home or data collection capabilities. Where such functionality exists, obtain the users permission for it to operate before collecting any data.', 10, 'https://cwe.mitre.org/data/definitions/359', 2)
        c.question_id = 52
        c.kb_id = 359
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.2.2', 'Verify that the application does not ask for unnecessary or excessive permissions to privacy related features or sensors, such as contacts, cameras, microphones, or location.', 10, 'https://cwe.mitre.org/data/definitions/272', 2)
        c.question_id = 52
        c.kb_id = 272
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.2.3', 'Verify that the application source code and third party libraries do not contain back doors, such as hard-coded or additional undocumented accounts or keys, code obfuscation, undocumented binary blobs, rootkits, or anti-debugging, insecure debugging features, or otherwise out of date, insecure, or hidden functionality that could be used maliciously if discovered.', 10, 'https://cwe.mitre.org/data/definitions/507', 3)
        c.question_id = 52
        c.kb_id = 507
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.2.4', 'Verify that the application source code and third party libraries does not contain time bombs by searching for date and time related functions.', 10, 'https://cwe.mitre.org/data/definitions/511', 3)
        c.question_id = 52
        c.kb_id = 511
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.2.5', 'Verify that the application source code and third party libraries does not contain malicious code, such as salami attacks, logic bypasses, or logic bombs.', 10, 'https://cwe.mitre.org/data/definitions/511', 3)
        c.question_id = 52
        c.kb_id = 511
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.2.6', 'Verify that the application source code and third party libraries do not contain Easter eggs or any other potentially unwanted functionality.', 10, 'https://cwe.mitre.org/data/definitions/507', 3)
        c.question_id = 52
        c.kb_id = 507
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('10.3.1', 'Verify that if the application has a client or server auto-update feature, updates should be obtained over secure channels and digitally signed. The update code must validate the digital signature of the update before installing or executing the update.', 10, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/16', 1)
        c.question_id = 53
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('10.3.2', 'Verify that the application employs integrity protections, such as code signing or sub-resource integrity. The application must not load or execute code from untrusted sources, such as loading includes, modules, plugins, code, or libraries from untrusted sources or the Internet.', 10, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/353', 1)
        c.question_id = 53
        c.kb_id = 353
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('10.3.3', 'Verify that the application has protection from sub-domain takeovers if the application relies upon DNS entries or DNS sub-domains, such as expired domain names, out of date DNS pointers or CNAMEs, expired projects at public source code repos, or transient cloud APIs, serverless functions, or storage buckets (autogen-bucket-id.cloud.example.com) or similar. Protections can include ensuring that DNS names used by applications are regularly checked for expiry or change.', 10, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/350', 1)
        c.question_id = 53
        c.kb_id = 350
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.0', 'Business Logic Verification Requirements', 11, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.1', 'Verify the application will only process business logic flows for the same user in sequential step order and without skipping steps.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/841', 1)
        c.question_id = 54
        c.kb_id = 841
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.2', 'Verify the application will only process business logic flows with all steps being processed in realistic human time, i.e. transactions are not submitted too quickly.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/779', 1)
        c.question_id = 54
        c.kb_id = 779
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.3', 'Verify the application has appropriate limits for specific business actions or transactions which are correctly enforced on a per user basis.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/770', 1)
        c.question_id = 54
        c.kb_id = 770
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.4', 'Verify the application has sufficient anti-automation controls to detect and protect against data exfiltration, excessive business logic requests, excessive file uploads or denial of service attacks.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/770', 1)
        c.question_id = 54
        c.kb_id = 770
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.5', 'Verify the application has business logic limits or validation to protect against likely business risks or threats, identified using threat modelling or similar methodologies.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/841', 1)
        c.question_id = 54
        c.kb_id = 841
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.6', 'Verify the application does not suffer from "time of check to time of use" (TOCTOU) issues or other race conditions for sensitive operations.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/367', 2)
        c.question_id = 54
        c.kb_id = 367
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.7', 'Verify the application monitors for unusual events or activity from a business logic perspective. For example, attempts to perform actions out of order or actions which a normal user would never attempt', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/754', 2)
        c.question_id = 54
        c.kb_id = 754
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('11.1.8', 'Verify the application has configurable alerting when automated attacks or unusual activity is detected.', 11, 'https://cheatsheetseries.owasp.org/cheatsheets/Abuse_Case_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/390', 2)
        c.question_id = 54
        c.kb_id = 390
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.0', 'File and Resources Verification Requirements', 12, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.1.1', 'Verify that the application will not accept large files that could fill up storage or cause a denial of service attack.', 12, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/400', 1)
        c.question_id = 55
        c.kb_id = 400
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('12.1.2', 'Verify that compressed files are checked for "zip bombs" - small input files that will decompress into huge files thus exhausting file storage limits.', 12, 'https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/400', 2)
        c.question_id = 55
        c.kb_id = 400
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('12.1.3', 'Verify that a file size quota and maximum number of files per user is enforced to ensure that a single user cannot fill up the storage with too many files, or excessively large files.', 12, 'https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/409', 2)
        c.question_id = 55
        c.kb_id = 409
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('12.2.1', 'Verify that files obtained from untrusted sources are validated to be of expected type based on the files content.', 12, 'https://cheatsheetseries.owasp.org/cheatsheets/File_Upload_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Third_Party_Javascript_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/434', 2)
        c.question_id = 56
        c.kb_id = 434
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('12.3.1', 'Verify that user-submitted filename metadata is not used directly with system or framework file and URL API to protect against path traversal.', 12, 'https://cwe.mitre.org/data/definitions/22', 1)
        c.question_id = 57
        c.kb_id = 22
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.3.2', 'Verify that user-submitted filename metadata is validated or ignored to prevent the disclosure, creation, updating or removal of local files (LFI).', 12, 'https://cwe.mitre.org/data/definitions/73', 1)
        c.question_id = 57
        c.kb_id = 73
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.3.3', 'Verify that user-submitted filename metadata is validated or ignored to prevent the disclosure or execution of remote files (RFI) which may also lead to SSRF.', 12, 'https://cwe.mitre.org/data/definitions/98', 1)
        c.question_id = 57
        c.kb_id = 98
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.3.4', 'Verify that the application protects against reflective file download (RFD) by validating or ignoring user-submitted filenames in a JSON, JSONP, or URL parameter, the response Content-Type header should be set to text/plain, and the Content-Disposition header should have a fixed filename.', 12, 'https://cwe.mitre.org/data/definitions/641', 1)
        c.question_id = 57
        c.kb_id = 641
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.3.5', 'Verify that untrusted file metadata is not used directly with system API or libraries, to protect against OS command injection.', 12, 'https://cwe.mitre.org/data/definitions/78', 1)
        c.question_id = 57
        c.kb_id = 78
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('12.3.6', 'Verify that the application does not include and execute functionality from untrusted sources, such as unverified content distribution networks, JavaScript libraries, node npm libraries, or server-side DLLs.', 12, 'https://cwe.mitre.org/data/definitions/829', 2)
        c.question_id = 57
        c.kb_id = 829
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.4.1', 'Verify that files obtained from untrusted sources are stored outside the web root, with limited permissions, preferably with strong validation.', 12, 'https://cwe.mitre.org/data/definitions/922', 1)
        c.question_id = 58
        c.kb_id = 922
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.4.2', 'Verify that files obtained from untrusted sources are scanned by antivirus scanners to prevent upload of known malicious content.', 12, 'https://cwe.mitre.org/data/definitions/509', 1)
        c.question_id = 58
        c.kb_id = 509
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.5.1', 'Verify that the web tier is configured to serve only files with specific file extensions to prevent unintentional information and source code leakage. For example, backup files (e.g. .bak) temporary working files (e.g. .swp) compressed files (.zip, .tar.gz, etc) and other extensions commonly used by editors should be blocked unless required.', 12, 'https://cwe.mitre.org/data/definitions/552', 1)
        c.question_id = 59
        c.kb_id = 552
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.5.2', 'Verify that direct requests to uploaded files will never be executed as HTML/JavaScript content.', 12, 'https://cwe.mitre.org/data/definitions/434', 1)
        c.question_id = 59
        c.kb_id = 434
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('12.6.1', 'Verify that the web or application server is configured with a whitelist of resources or systems to which the server can send requests or load data/files from.', 12, 'https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/918', 1)
        c.question_id = 60
        c.kb_id = 918
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.0', 'API and Web Service Verification Requirements', 13, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.1.1', 'Verify that all application components use the same encodings and parsers to avoid parsing attacks that exploit different URI or file parsing behavior that could be used in SSRF and RFI attacks.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/Web_Service_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 1)
        c.question_id = 61
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.1.2', 'Verify that access to administration and management functions is limited to authorized administrators.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/Web_Service_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/419', 1)
        c.question_id = 61
        c.kb_id = 419
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.1.3', 'Verify API URLs do not expose sensitive information, such as the API key, session tokens etc.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/Web_Service_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/598', 1)
        c.question_id = 61
        c.kb_id = 598
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('13.1.4', 'Verify that authorization decisions are made at both the URI, enforced by programmatic or declarative security at the controller or router, and at the resource level, enforced by model-based permissions.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/Web_Service_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/285', 2)
        c.question_id = 61
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('13.1.5', 'Verify that requests containing unexpected or missing content types are rejected with appropriate headers (HTTP response status 406 Unacceptable or 415 Unsupported Media Type).', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/Web_Service_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/434', 2)
        c.question_id = 61
        c.kb_id = 434
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.2.1', 'Verify that enabled RESTful HTTP methods are a valid choice for the user or action, such as preventing normal users using DELETE or PUT on protected API or resources.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/650', 1)
        c.question_id = 62
        c.kb_id = 650
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.2.2', 'Verify that JSON schema validation is in place and verified before accepting input.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/20', 1)
        c.question_id = 62
        c.kb_id = 20
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.2.3', 'Verify that RESTful web services that utilize cookies are protected from Cross-Site Request Forgery via the use of at least one or more of the following: triple or double submit cookie pattern, CSRF nonces, or ORIGIN request header checks.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/352', 1)
        c.question_id = 62
        c.kb_id = 352
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('13.2.4', 'Verify that REST services have anti-automation controls to protect against excessive calls, especially if the API is unauthenticated.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/779', 2)
        c.question_id = 62
        c.kb_id = 779
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('13.2.5', 'Verify that REST services explicitly check the incoming Content-Type to be the expected one, such as application/xml or application/JSON.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/436', 2)
        c.question_id = 62
        c.kb_id = 436
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('13.2.6', 'Verify that the message headers and payload are trustworthy and not modified in transit. Requiring strong encryption for transport (TLS only) may be sufficient in many cases as it provides both confidentiality and integrity protection. Per- message digital signatures can provide additional assurance on top of the transport protections for high-security applications but bring with them additional complexity and risks to weigh against the benefits', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/REST_Assessment_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/REST_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/598', 2)
        c.question_id = 62
        c.kb_id = 598
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.3.1', 'Verify that XSD schema validation takes place to ensure a properly formed XML document, followed by validation of each input field before any processing of that data takes place.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/20', 1)
        c.question_id = 63
        c.kb_id = 20
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('13.3.2', 'Verify that the message payload is signed using WS-Security to ensure reliable transport between client and service.', 13, 'https://cheatsheetseries.owasp.org/cheatsheets/XML_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/345', 2)
        c.question_id = 63
        c.kb_id = 345
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('13.4.1', 'Verify that query whitelisting or a combination of depth limiting and amount limiting should be used to prevent GraphQL or data layer expression denial of service (DoS) as a result of expensive, nested queries. For more advanced scenarios, query cost analysis should be used.', 13, 'https://cwe.mitre.org/data/definitions/770', 2)
        c.question_id = 64
        c.kb_id = 770
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('13.4.2', 'Verify that GraphQL or other data layer authorization logic should be implemented at the business logic layer instead of the GraphQL layer.', 13, 'https://cwe.mitre.org/data/definitions/285', 2)
        c.question_id = 64
        c.kb_id = 285
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.0', 'Configuration Verification Requirements', 14, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.1.1', 'Verify that the application build and deployment processes are performed in a secure and repeatable way, such as CI / CD automation, automated configuration management, and automated deployment scripts', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html', 2)
        c.question_id = 65
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.1.2', 'Verify that compiler flags are configured to enable all available buffer overflow protections and warnings, including stack randomization, data execution prevention, and to break the build if an unsafe pointer, memory, format string, integer, or string operations are found.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/120', 2)
        c.question_id = 65
        c.kb_id = 120
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.1.3', 'Verify that server configuration is hardened as per the recommendations of the application server and frameworks in use.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/16', 2)
        c.question_id = 65
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.1.4', 'Verify that the application, configuration, and all dependencies can be re- deployed using automated deployment scripts, built from a documented and tested runbook in a reasonable time, or restored from backups in a timely fashion.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html', 2)
        c.question_id = 65
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.1.5', 'Verify that authorized administrators can verify the integrity of all security-relevant configurations to detect tampering.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html', 3)
        c.question_id = 65
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.2.1', 'Verify that all components are up to date, preferably using a dependency checker during build or compile time.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1104', 1)
        c.question_id = 65
        c.kb_id = 1104
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.2.2', 'Verify that all unneeded features, documentation, samples, configurations are removed, such as sample applications, platform documentation, and default or example users.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/531', 1)
        c.question_id = 66
        c.kb_id = 531
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.2.3', 'Verify that if application assets, such as JavaScript libraries, CSS stylesheets or web fonts, are hosted externally on a content delivery network (CDN) or external provider, Subresource Integrity (SRI) is used to validate the integrity of the asset.', 14, 'https://cwe.mitre.org/data/definitions/15', 1)
        c.question_id = 66
        c.kb_id = 15
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.2.4', 'Verify that third party components come from pre-defined, trusted and continually maintained repositories', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/828', 2)
        c.question_id = 66
        c.kb_id = 828
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.2.5', 'Verify that an inventory catalog is maintained of all third party libraries in use.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.html', 2)
        c.question_id = 66
        c.kb_id = 2
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.2.6', 'Verify that the attack surface is reduced by sandboxing or encapsulating third party libraries to expose only the required behaviour into the application.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html,https://cheatsheetseries.owasp.org/cheatsheets/Vulnerable_Dependency_Management_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/265', 2)
        c.question_id = 66
        c.kb_id = 265
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.3.1', 'Verify that web or application server and framework error messages are configured to deliver user actionable, customized responses to eliminate any unintended security disclosures.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Error_Handling_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/209', 1)
        c.question_id = 67
        c.kb_id = 209
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.3.2', 'Verify that web or application server and application framework debug modes are disabled in production to eliminate debug features, developer consoles, and unintended security disclosures.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Error_Handling_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/497', 1)
        c.question_id = 67
        c.kb_id = 497
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.3.3', 'Verify that the HTTP headers or any part of the HTTP response do not expose detailed version information of system components.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Error_Handling_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/200', 1)
        c.question_id = 67
        c.kb_id = 200
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.4.1', 'Verify that every HTTP response contains a content type header specifying a safe character set (e.g., UTF-8, ISO 8859-1).', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/173', 1)
        c.question_id = 68
        c.kb_id = 173
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.4.2', 'Verify that all API responses contain Content-Disposition: attachment; filename="api.json" (or other appropriate filename for the content type).', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 1)
        c.question_id = 68
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.4.3', 'Verify that a content security policy (CSPv2) is in place that helps mitigate impact for XSS attacks like HTML, DOM, JSON, and JavaScript injection vulnerabilities.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/1021', 1)
        c.question_id = 68
        c.kb_id = 1021
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.4.4', 'Verify that all responses contain X-Content-Type-Options: nosniff.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 1)
        c.question_id = 68
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('14.4.6', 'Verify that a suitable "Referrer-Policy" header is included, such as "no-referrer" or "same-origin".', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/116', 1)
        c.question_id = 68
        c.kb_id = 116
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.4.7', 'Verify that a suitable X-Frame-Options or Content-Security-Policy: frame-ancestors header is in use for sites where content should not be embedded in a third-party site.', 14, 'https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html,https://cwe.mitre.org/data/definitions/346', 1)
        c.question_id = 68
        c.kb_id = 346
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.5.1', 'Verify that the application server only accepts the HTTP methods in use by the application or API, including pre-flight OPTIONS.', 14, 'https://cwe.mitre.org/data/definitions/749', 1)
        c.question_id = 69
        c.kb_id = 749
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.5.2', 'Verify that the supplied Origin header is not used for authentication or access control decisions, as the Origin header can easily be changed by an attacker.', 14, 'https://cwe.mitre.org/data/definitions/346', 1)
        c.question_id = 69
        c.kb_id = 346
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('14.5.3', 'Verify that the cross-domain resource sharing (CORS) Access-Control-Allow-Origin header uses a strict white-list of trusted domains to match against and does not support the "null" origin.', 14, 'https://cwe.mitre.org/data/definitions/346', 1)
        c.question_id = 69
        c.kb_id = 346
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('14.5.4', 'Verify that HTTP headers added by a trusted proxy or SSO devices, such as a bearer token, are authenticated by the application.', 14, 'https://cwe.mitre.org/data/definitions/306', 2)
        c.question_id = 69
        c.kb_id = 306
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.0', 'Architecture, Design and Threat Modeling Requirements', 15, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
            
        c = ChecklistKB('2.0', 'Data Storage and Privacy Requirements', 16, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('3.0', 'Cryptography Requirements', 17, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
            
        c = ChecklistKB('4.0', 'Authentication and Session Management Requirements', 18, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('5.0', 'Network Communication Requirements', 19, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        
        c = ChecklistKB('6.0', 'Platform Interaction Requirements', 20, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()

        c = ChecklistKB('7.0', 'Code Quality and Build Setting Requirements', 21, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
            
        c = ChecklistKB('8.0', 'Resilience Requirements', 22, None, None)
        c.question_id = None
        c.kb_id = 1
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.1', 'All app components are identified and known to be needed.', 15, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05h-Testing-Platform-Interaction.md#testing-for-insecure-configuration-of-instant-apps-mstg-arch-1-mstg-arch-7', 1)
        c.kb_id = 2001
        db.session.add(c)
        db.session.commit()


        c = ChecklistKB('1.2', 'Security controls are never enforced only on the client side, but on the respective remote endpoints.', 15, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#verifying-that-appropriate-authentication-is-in-place-mstg-arch-2-and-mstg-auth-1,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04h-Testing-Code-Quality.md#injection-flaws-mstg-arch-2-and-mstg-platform-2', 1)
        c.kb_id = 2002
        c.question_id = 74
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.3', 'A high-level architecture for the mobile app and all connected remote services has been defined and security has been addressed in that architecture.', 15, '', 1)
        c.kb_id = 2003
        db.session.add(c)
        db.session.commit()


        c = ChecklistKB('1.4', 'Data considered sensitive in the context of the mobile app is clearly identified.', 15, '', 1)
        c.kb_id = 2004
        c.question_id = 79
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.5', 'All app components are defined in terms of the business functions and/or security functions they provide.', 15, '', 2)
        c.kb_id = 2005
        c.question_id = 79
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.6', 'A threat model for the mobile app and the associated remote services has been produced that identifies potential threats and countermeasures.', 15, 'https://owasp.org/www-community/Threat_Modeling,https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html', 2)
        c.kb_id = 2006
        db.session.add(c)
        db.session.commit()


        c = ChecklistKB('1.7', 'All security controls have a centralized implementation.', 15, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05h-Testing-Platform-Interaction.md#testing-for-insecure-configuration-of-instant-apps-mstg-arch-1-mstg-arch-7', 2)
        c.kb_id = 2007
        c.question_id = 73
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.8', 'There is an explicit policy for how cryptographic keys (if any) are managed, and the lifecycle of cryptographic keys is enforced. Ideally, follow a key management standard such as NIST SP 800-57.', 15, '', 2)
        c.kb_id = 2008
        c.question_id = 76
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.10', 'Security is addressed within all parts of the software development lifecycle.', 15, '', 2)
        c.kb_id = 2010
        c.question_id = 80
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.11', 'A responsible disclosure policy is in place and effectively applied.', 15, '', 2)
        c.kb_id = 2011
        c.question_id = 77
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('1.12', 'The app should comply with privacy laws and regulations.', 15, '', 1)
        c.kb_id = 2012
        c.question_id = 75
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('2.2', 'No sensitive data should be stored outside of the app container or system credential storage facilities.', 16, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05d-Testing-Data-Storage.md#testing-local-storage-for-sensitive-data-mstg-storage-1-and-mstg-storage-2,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06d-Testing-Data-Storage.md#testing-local-data-storage-mstg-storage-1-and-mstg-storage-2', 1)
        c.kb_id = 2013
        c.question_id = 84
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('2.12', 'The app educates the user about the types of personally identifiable information processed, as well as security best practices the user should follow in using the app.', 16, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04i-Testing-user-interaction.md#testing-user-education-mstg-storage-12', 2)
        c.kb_id = 2023
        c.question_id = 86
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('2.13', 'No sensitive data should be stored locally on the mobile device. Instead, data should be retrieved from a remote endpoint when needed and only be kept in memory.', 16, '', 2)
        c.kb_id = 2025
        c.question_id = 84
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('2.14', 'If sensitive data is still required to be stored locally, it should be encrypted using a key derived from hardware backed storage which requires authentication.', 16, '', 2)
        c.kb_id = 2025
        c.question_id = 84
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('2.15', 'The app’s local storage should be wiped after an excessive number of failed authentication attempts.', 16, '', 2)
        c.kb_id = 2088
        c.question_id = 81
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('3.3', 'The app uses cryptographic primitives that are appropriate for the particular use-case, configured with parameters that adhere to industry best practices.', 17, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06e-Testing-Cryptography.md#verifying-the-configuration-of-cryptographic-standard-algorithms-mstg-crypto-2-and-mstg-crypto-3,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04g-Testing-Cryptography.md#common-configuration-issues-mstg-crypto-1-mstg-crypto-2-and-mstg-crypto-3,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05e-Testing-Cryptography.md#testing-the-configuration-of-cryptographic-standard-algorithms-mstg-crypto-2-mstg-crypto-3-and-mstg-crypto-4', 2)
        c.kb_id = 2027
        c.question_id = 88
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('3.4', 'The app does not use cryptographic protocols or algorithms that are widely considered deprecated for security purposes.', 17, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04g-Testing-Cryptography.md#identifying-insecure-andor-deprecated-cryptographic-algorithms-mstg-crypto-4,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05e-Testing-Cryptography.md#testing-the-configuration-of-cryptographic-standard-algorithms-mstg-crypto-2-mstg-crypto-3-and-mstg-crypto-4', 2)
        c.kb_id = 2028
        c.question_id = 88
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.4', 'The remote endpoint terminates the existing session when the user logs out.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#testing-user-logout-mstg-auth-4', 1)
        c.kb_id = 2034
        c.question_id = 91
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.5', 'A password policy exists and is enforced at the remote endpoint.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#testing-best-practices-for-passwords-mstg-auth-5-and-mstg-auth-6', 1)
        c.kb_id = 2035
        c.question_id = 90
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.6', 'The remote endpoint implements a mechanism to protect against the submission of credentials an excessive number of times.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#testing-best-practices-for-passwords-mstg-auth-5-and-mstg-auth-6', 1)
        c.kb_id = 2036
        c.question_id = 89
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.7', 'Sessions are invalidated at the remote endpoint after a predefined period of inactivity and access tokens expire.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#testing-session-timeout-mstg-auth-7', 1)
        c.kb_id = 2037
        c.question_id = 91
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.8', 'Biometric authentication, if any, is not event-bound (i.e. using an API that simply returns "true" or "false"). Instead, it is based on unlocking the keychain/keystore.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06f-Testing-Local-Authentication.md#testing-local-authentication-mstg-auth-8-and-mstg-storage-11,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05f-Testing-Local-Authentication.md#testing-biometric-authentication-mstg-auth-8', 2)
        c.kb_id = 2038
        c.question_id = 90
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.10', 'Sensitive transactions require step-up authentication.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#testing-two-factor-authentication-and-step-up-authentication-mstg-auth-9-and-mstg-auth-10', 2)
        c.kb_id = 2039
        c.question_id = 90
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.11', 'The app informs the user of all sensitive activities with their account. Users are able to view a list of devices, view contextual information (IP address, location, etc.), and to block specific devices.', 18, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04e-Testing-Authentication-and-Session-Management.md#testing-login-activity-and-device-blocking-mstg-auth-11', 2)
        c.kb_id = 2040
        c.question_id = 89
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('4.12', 'Authorization models should be defined and enforced at the remote endpoint.', 18, '', 1)
        c.kb_id = 2079
        c.question_id = 90
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('5.4', 'The app either uses its own certificate store, or pins the endpoint certificate or public key, and subsequently does not establish connections with endpoints that offer a different certificate or key, even if signed by a trusted CA.', 19, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05g-Testing-Network-Communication.md#testing-custom-certificate-stores-and-certificate-pinning-mstg-network-4,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05g-Testing-Network-Communication.md#testing-the-network-security-configuration-settings-mstg-network-4,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06g-Testing-Network-Communication.md#testing-custom-certificate-stores-and-certificate-pinning-mstg-network-3-and-mstg-network-4', 2)
        c.kb_id = 2044
        c.question_id = 95
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('5.5', 'The app doesn\'t rely on a single insecure communication channel (email or SMS) for critical operations, such as enrollments and account recovery.', 19, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x04f-Testing-Network-Communication.md#making-sure-that-critical-operations-use-secure-communication-channels-mstg-network-5', 2)
        c.kb_id = 2045
        c.question_id = 93
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('5.6', 'The app only depends on up-to-date connectivity and security libraries.', 19, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05g-Testing-Network-Communication.md#testing-the-security-provider-mstg-network-6', 2)
        c.kb_id = 2091
        c.question_id = 94
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('6.3', 'The app does not export sensitive functionality via custom URL schemes, unless these mechanisms are properly protected.', 20, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06h-Testing-Platform-Interaction.md#testing-custom-url-schemes-mstg-platform-3,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05h-Testing-Platform-Interaction.md#testing-custom-url-schemes-mstg-platform-3', 1)
        c.kb_id = 2049
        c.question_id = 96
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('6.6', 'WebViews are configured to allow only the minimum set of protocol handlers required (ideally, only https is supported). Potentially dangerous handlers, such as file, tel and app-id, are disabled.', 20, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06h-Testing-Platform-Interaction.md#testing-webview-protocol-handlers-mstg-platform-6,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05h-Testing-Platform-Interaction.md#testing-webview-protocol-handlers-mstg-platform-6', 1)
        c.kb_id = 2052
        c.question_id = 105
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('6.9', 'The app protects itself against screen overlay attacks. (Android only)', 20, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05h-Testing-Platform-Interaction.md#testing-for-overlay-attacks-mstg-platform-9', 2)
        c.kb_id = 2055
        c.question_id = 98    
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('6.10', 'A WebView\'s cache, storage, and loaded resources (JavaScript, etc.) should be cleared before the WebView is destroyed.', 20, '', 2)
        c.kb_id = 2056
        c.question_id = 97
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('6.11', 'Verify that the app prevents usage of custom third-party keyboards whenever sensitive data is entered.', 20, '', 2)
        c.kb_id = 2057
        c.question_id = 97
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('7.7', 'Error handling logic in security controls denies access by default.', 21, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05i-Testing-Code-Quality-and-Build-Settings.md#testing-exception-handling-mstg-code-6-and-mstg-code-7,https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06i-Testing-Code-Quality-and-Build-Settings.md#testing-exception-handling-mstg-code-6', 1)
        c.kb_id = 2063
        c.question_id = 99
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('8.6', 'The app detects, and responds to, tampering the code and data in its own memory space.', 22, 'https://github.com/OWASP/owasp-mstg/blob/master/Document/0x05j-Testing-Resiliency-Against-Reverse-Engineering.md#testing-runtime-integrity-checks-mstg-resilience-6', 3)
        c.kb_id = 2072
        c.question_id = 102
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('8.7', 'The app implements multiple mechanisms in each defense category (8.1 to 8.6). Note that resiliency scales with the amount, diversity of the originality of the mechanisms used.', 22, '', 3)
        c.kb_id = 2073
        c.question_id = 101
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('8.8', 'The detection mechanisms trigger responses of different types, including delayed and stealthy responses.', 22, '', 3)
        c.kb_id = 2074
        c.question_id = 101
        db.session.add(c)
        db.session.commit()
        ...
        c = ChecklistKB('8.13', 'As a defense in depth, next to having solid hardening of the communicating parties, application level payload encryption can be applied to further impede eavesdropping.', 22, '', 3)
        c.kb_id = 2078
        c.question_id = 101
        db.session.add(c)
        db.session.commit()
