...
--ASVS lvl 1
--
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes authentication?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that extend the primairy authentication mechanism (re-authentication/password forget/step-up/etc)?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that sends parameters in the request body such as i.e POST requests?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that send parameters and data over a GET request method?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that send parameters and data any request methods other then POST and GET?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that use SQL?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that use LDAP?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that perform system commands?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that perform local/remote file inclusion?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functions that uses/parses XML?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changess functions that reflect user supplied input on the client-side?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changess functions that use automatic variable binding (ORM)?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changess WYSIWIG like editors?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes JSON?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality that stores data in the local/client/session storage?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality that needs secure random tokens (password forget link, CSRF, ETC)?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality that requires encryption?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality which allows users to upload files or other data structures to the application?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality which implement/changess functionality that needs to share data 'Cross Origin'?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality that contain forwards or redirects?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality that are API?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (0, "Does the sprint implement/changes functionality that are mobile (native, xamarin, corona, etc)?");
--
--ASVS lvl 2
--
...
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changes functions that use SQL?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changes functions that use LDAP?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changes functions that perform system commands?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changes functions that perform local/remote file inclusion?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changes functions that uses/parses XML?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changess functions that reflect user supplied input on the client-side?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changess functions that use automatic variable binding (ORM)?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changess WYSIWIG like editors?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (1, "Does the sprint implement/changes JSON?");
--
--ASVS lvl 3
--
...
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes functions that send parameters and data any request methods other then POST and GET?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes functions that use SQL?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes functions that use LDAP?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes functions that perform system commands?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes functions that perform local/remote file inclusion?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes functions that uses/parses XML?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changess functions that reflect user supplied input on the client-side?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changess functions that use automatic variable binding (ORM)?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changess WYSIWIG like editors?");
INSERT OR REPLACE INTO `questions_sprint` (`checklist_type`, `question`) VALUES (2, "Does the sprint implement/changes JSON?");
...
--ASVS lvl 1
--
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (0, "You have a blueprint for the design, architecture and validated this using ASVS?");
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (0, "You have a blueprint for performing secure configuration, hardening of the application server and validated this using ASVS?");
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (0, "You have a central Single Sign On service and validated this service using ASVS?");
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (0, "You have a central Identity Management System service and validated this service using ASVS?");
--
--ASVS lvl 2
--
...
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (1, "You have a central Single Sign On service and validated this service using ASVS?");
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (1, "You have a central Identity Management System service and validated this service using ASVS?");
--
--ASVS lvl 3
--
...
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (2, "You have a central Single Sign On service and validated this service using ASVS?");
INSERT OR REPLACE INTO `questions_pre` (`checklist_type`, `question`) VALUES (2, "You have a central Identity Management System service and validated this service using ASVS?");
...
--ASVS
--
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('1.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('8.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('9.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('10.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('2.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('11.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('13.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('15.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('16.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('17.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('18.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('19.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('3.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('4.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('5.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('7.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 0);
...
--MASVS
--
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('1.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('2.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('3.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('4.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('5.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('6.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('7.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
...
INSERT OR REPLACE INTO `checklists_kb` (`checklistID`, `question_sprint_ID`, `question_pre_ID`, `kbID`, `codeID_php`, `codeID_asp`, `codeID_java`, `codeID_python`, `include_always`, `include_first`, `checklist_type`) VALUES ('8.0', 0, 0, 0, 0, 0, 0, 0, 'False', 'False', 1);
