...
![Risk Model Factors](assets/Riskfactors.jpeg)
...
When using [STRIDE][wiki-stride], the following threat-mitigation table can be used to identify techniques that can be employed to mitigate the threats.
