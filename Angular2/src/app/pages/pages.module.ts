...
import {TrainingMenuComponent} from './training/menu/menu.component';
...
@NgModule({
  declarations: [
    ...
    IndexComponent, CreateQuestionnaireComponent, UpdateChecklistTypeComponent, CreateChecklistTypeComponent,
