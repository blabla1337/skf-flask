...
describe('Code examples service', () => {
  ...
  beforeEach(() => {
    ...
    localStorage.removeItem('code_lang')
  });

  it('Should test the request method, headers, endpoint && request handling', inject([CodeExamplesService, MockBackend], (service: CodeExamplesService, backend: MockBackend) => {
