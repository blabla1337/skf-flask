...
export class ChecklistService {
  ...
  newChecklistItem(checklistType: number, checklistID:number ,content:string, kbID:number, include_always:string, include_first:string, question_sprint_ID:number, question_pre_ID:number, cwe:string): Observable<any> {
    console.log()
    return this.http
  ...
  updateChecklistItem(checklistType: number, checklistID:number ,content:string, kbID:number, include_always:string, include_first:string, question_sprint_ID:number, question_pre_ID:number, cwe:string): Observable<any> {
