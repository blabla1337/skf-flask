...
<br/>
<a class='fa fa-file-code-o fa-4x' href='/function/addfunctions/<?php echo htmlspecialchars($projectID); ?>/'></a>
<br/><br/><br/>
<a href='/function/addfunctions/<?php echo htmlspecialchars($projectID); ?>/'><button class="btn btn-small btn-theme04">Start project</button></a>
</div>
</div>
...
<br/>
<a class='fa fa-file-text-o fa-4x' href='/checklist/summary/<?php echo htmlspecialchars($projectID); ?>/'></a>
<br/><br/><br/>
<a href='/checklist/summary/<?php echo htmlspecialchars($projectID); ?>/'><button class="btn btn-small btn-theme04">Start project</button></a>
</div>
</div>
